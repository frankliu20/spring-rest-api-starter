...
/**
 * {@link OnRegistrationCompleteEvent} Unit Test.
 * 
 * @author madmath03
 */
public class OnRegistrationCompleteEventTest extends AbstractMailSendingEventTest<User> {
  ...
  protected AbstractMailSendingEvent<User> buildTestEvent() {
    return new OnRegistrationCompleteEvent(user, locale, appUrl);
  }
