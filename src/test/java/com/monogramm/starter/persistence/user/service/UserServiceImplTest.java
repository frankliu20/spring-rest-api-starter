...
/**
 * {@link UserServiceImpl} Unit Test.
 * 
 * @author madmath03
 */
public class UserServiceImplTest extends AbstractGenericServiceTest<User, UserDto, UserServiceImpl> {
  ...
  @Override
  protected UserServiceImpl buildTestService() {
    return new UserServiceImpl(getMockRepository(), roleDao, parameterDao,
        getMockAuthenticationFacade());
  }

  @Override
  protected UserRepository buildMockRepository() {
    return getMockUserRepository();
  }

  @Override
  public UserRepository getMockRepository() {
    return (UserRepository) super.getMockRepository();
  }
  ...
  /**
   * Test method for {@link UserServiceImpl#add(com.monogramm.starter.persistence.user.entity.User)}.
   */
  @Override
  @Test
  public void testAdd() {
  ...
  /**
   * Test method for {@link UserServiceImpl#getRoleRepository()}.
   */
  @Test
  ...
  /**
   * Test method for {@link UserServiceImpl#getParameterRepository()}.
   */
  @Test
  ...
  /**
   * Test method for {@link UserServiceImpl#findAllContainingUsername(java.lang.String)}.
   */
  @Test
  ...
  /**
   * Test method for {@link UserServiceImpl#findAllContainingEmail(java.lang.String)}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link UserServiceImpl#findAllContainingUsernameOrEmail(java.lang.String, java.lang.String)}.
   */
  @Test
  ...
  /**
   * Test method for {@link UserServiceImpl#findByUsername(String)}.
   * 
  ...
  /**
   * Test method for {@link UserServiceImpl#findByEmail(String)}.
   * 
  ...
  /**
   * Test method for {@link UserServiceImpl#findByUsernameOrEmail(String, String)}.
   * 
  ...
  /**
   * Test method for {@link UserServiceImpl#update(com.monogramm.starter.persistence.user.entity.User)}.
   * 
  ...
  /**
   * Test method for {@link UserServiceImpl#setPassword(UUID, char[])}.
   * 
   * @throws UserNotFoundException if the user entity to update is not found.
   */
  @Test
  ...
  /**
   * Test method for {@link UserServiceImpl#setPasswordByOwner(UUID, char[], UUID)}.
   * 
   * @throws UserNotFoundException if the user entity to update is not found.
   */
  @Test
  ...
  /**
   * Test method for {@link UserServiceImpl#setEnabled(UUID, boolean)}.
   * 
   * @throws UserNotFoundException if the user entity to update is not found.
   */
  @Test
  ...
  /**
   * Test method for {@link UserServiceImpl#enable(UUID)}.
   * 
   * @throws UserNotFoundException if the user entity to update is not found.
   */
  @Test
  ...
  /**
   * Test method for {@link UserServiceImpl#enableByOwner(UUID, UUID)}.
   * 
   * @throws UserNotFoundException if the user entity to update is not found.
   */
  @Test
  ...
  /**
   * Test method for {@link UserServiceImpl#register(com.monogramm.starter.dto.user.RegistrationDto)}.
   * 
  ...
  /**
   * Test method for {@link UserServiceImpl#verify(UUID)}.
   * 
   * @throws UserNotFoundException if the user entity to update is not found.
   */
  @Test
  ...
  /**
   * Test method for {@link UserServiceImpl#verifyByOwner(UUID, UUID)}.
   * 
   * @throws UserNotFoundException if the user entity to update is not found.
   */
  @Test
