...
/**
 * {@link VerificationTokenRepository} Integration Test.
 * 
 * @author madmath03
 */
public class VerificationTokenRepositoryIT
    extends AbstractGenericRepositoryIT<VerificationToken, VerificationTokenRepository> {
  ...
  /**
   * Test method for {@link VerificationTokenRepository#findAll()}.
   */
  @Override
  @Test
  ...
  /**
   * Test method for {@link VerificationTokenRepository#findByUserAndCode(UUID, String)}.
   * 
  ...
  /**
   * Test method for {@link VerificationTokenRepository#findByNameIgnoreCase(java.lang.String)}.
   */
  @Test
  ...
  /**
   * Test method for {@link VerificationTokenRepository#exists(java.util.UUID, java.lang.String)}.
   */
  @Test
